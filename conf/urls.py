...
from face_lens.views import home, logout_view, register, profile, profile_edit, profile_settings, camera, profile_photos, camera_save, analyze_photo  # , profile_photos
...
urlpatterns = [
    ...
    path('photo/<int:photo_id>/analyze/', analyze_photo, name='analyze_photo'),  # Анализ фото
